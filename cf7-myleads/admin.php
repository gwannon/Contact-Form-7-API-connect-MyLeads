...
function my_leads_page_settings() { 
	...
	if(isset($_REQUEST['send']) && $_REQUEST['send'] != '') { 
		...
		update_option('_my_leads_comments', $_POST['_my_leads_comments']);
	...
	<form method="post">
		...
		<h2><?php _e("Comentario", 'cf7-myleads'); ?>:</h2>
		<textarea name="_my_leads_comments"><?php echo get_option("_my_leads_comments"); ?></textarea><br/><br/>
		<hr/>
	...
	<ul>
		...
		<li>[tel* myleads-mobile-phone<]</li>
		<li>[email* myleads-email]</li>
		<li>[select* myleads-contact-form "E-mail|EMAIL" "Correo ordinario|MAIL" "Teléfono|PHONE" "SMS|SMS" "Sistemas de comunicación del vehículo, si los tiene|IN_CAR"]</li>
		<li>[acceptance myleads-conmkdealer optional] ... [/aceptance]</li>
		<li>[acceptance myleads-conanadealer optional] ... [/aceptance]</li>
		<li>[acceptance myleads-conmknsc optional] ... [/aceptance]</li>
		<li>[acceptance myleads-conanansc optional] ... [/aceptance]</li>
	</ul>
